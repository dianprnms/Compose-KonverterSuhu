package com.example.compose_konvertersuhu
...
import com.example.compose_konvertersuhu.ui.theme.ComposeKonverterSuhuTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            ComposeKonverterSuhuTheme {
                // A surface container using the 'background' color from the theme
                Surface(
                    modifier = Modifier.fillMaxSize(),
                    color = MaterialTheme.colorScheme.background
                ) {
                    StatefulAndStatelesTemperatureInputReview()
                }
            }
        }
    }
...
@Composable
fun StatefulAndStatelesTemperatureInputReview() {
    ComposeKonverterSuhuTheme {
        Column {
